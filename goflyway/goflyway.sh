...
check_root(){
	[[ $EUID != 0 ]] && echo -e "${Error} 当前非ROOT账号(或没有ROOT权限)。" && home=$HOME
}

check_root

Folder="$home/goflyway"
File="$home/goflyway/goflyway"
CONF="$home/goflyway/goflyway.conf"
Now_ver_File="$home/goflyway/ver.txt"
Log_File="$home/goflyway/goflyway.log"
